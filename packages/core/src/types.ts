import type { ProviderConfig, TTSProviderConfig } from './providers/types';
...
export interface PodcastConfig {
  ...
  // Provider/model seam. apiKey is omitted here — it is BYOK and injected at
  // call time (not persisted alongside the rest of the config).
  llm: Omit<ProviderConfig, 'apiKey'>;
